    ...
    // .then((response0)=> {
        ...
        .then(async (response1) => {
            ...
            const paymentIntent = await stripe.paymentIntents.create({
                ...
                currency: 'usd',
                application_fee_amount: parseInt(response1[0].Price) * .05,
